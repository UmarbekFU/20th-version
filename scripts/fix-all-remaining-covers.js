...
// Comprehensive mapping of all books to working Amazon URLs
const allBookCovers = {
  // Probability Theory
...
// Replace all OpenLibrary URLs with Amazon URLs
Object.entries(allBookCovers).forEach(([title, coverUrl]) => {
...
console.log('✅ Updated ALL remaining book cover images with working Amazon URLs!');
console.log(`📚 Updated ${Object.keys(allBookCovers).length} books`);
