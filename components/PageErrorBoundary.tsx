...
class PageErrorBoundary extends React.Component<PageErrorBoundaryProps, PageErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    if (process.env.NODE_ENV === 'production') {
      // Example: sendErrorToService(error, errorInfo, { page: this.props.pageName })
    }
  }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
          <div className="max-w-md w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center mb-6">
              {this.props.pageName ? `Something went wrong on the ${this.props.pageName} page.` : 'Something went wrong on this page.'}
            </p>
