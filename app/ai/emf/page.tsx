      ...
      <main className="min-h-screen pt-32">
        <div className="max-w-3xl mx-auto px-8">
          ...
          <header className="mb-12">
            <div className="notes-meta notes-text-muted mb-4">
              Sep 2
            </div>
            <h1 className="notes-heading text-3xl sm:text-4xl notes-text-primary mb-6">
              Everything is my fault
            </h1>
            <div className="flex items-center gap-4 notes-meta notes-text-secondary">
          ...
          <article className="prose prose-lg dark:prose-invert max-w-none">
            <p className="notes-content text-xl notes-text-secondary leading-relaxed mb-8">
              For years, I raged against the world.
            </p>

            <p className="notes-summary mb-6">
              They lied.<br/>
            ...
            <p className="notes-summary mb-8">
