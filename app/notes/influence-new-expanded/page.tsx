...
export default function InfluenceNewandExpandedPage() {
  // All data is self-contained - no external dependencies
  const title = "Influence, New and Expanded"
  const author = "Robert B. Cialdini"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Influence%2C%20New%20and%20Expanded+by+Robert%20B.%20Cialdini"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "The latest edition with new research. Updated insights on the psychology of persuasion."
  const category = "book"
