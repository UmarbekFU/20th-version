...
export default function InfluencePage() {
  ...
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Influence+by+Robert%20B.%20Cialdini"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The psychology of persuasion. Cialdini's classic work on the principles of influence."
  const category = "book"
