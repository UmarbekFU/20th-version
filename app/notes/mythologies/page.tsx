...
export default function MythologiesPage() {
  ...
  const title = "Mythologies"
  const author = "Roland Barthes"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Mythologies+by+Roland%20Barthes"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "A collection of essays on modern myths. Barthes's semiotic analysis of contemporary culture and ideology."
  const category = "book"
