...
export default function AlchemyPage() {
  ...
  const title = "Alchemy"
  const author = "Rory Sutherland"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Alchemy+by+Rory%20Sutherland"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "The surprising power of ideas that don't make sense. Sutherland explores how illogical solutions often work better than logical ones."
  const category = "book"
