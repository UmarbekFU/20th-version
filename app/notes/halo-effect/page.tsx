...
export default function TheHaloEffectPage() {
  // All data is self-contained - no external dependencies
  const title = "The Halo Effect"
  const author = "Phil Rosenzweig"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Halo%20Effect+by+Phil%20Rosenzweig"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "The delusion of connecting winning with winning. Rosenzweig's critique of business success stories and the illusions they create."
  const category = "book"
