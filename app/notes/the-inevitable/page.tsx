...
export default function TheInevitablePage() {
  ...
  const title = "The Inevitable"
  const author = "Kevin Kelly"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Inevitable+by+Kevin%20Kelly"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "Understanding the 12 technological forces that will shape our future. Kelly's vision of how technology will transform our world in the coming decades."
  const category = "book"
