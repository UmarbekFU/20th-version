...
export default function TheArtofSpendingMoneyPage() {
  // All data is self-contained - no external dependencies
  const title = "The Art of Spending Money"
  const author = "Morgan Housel"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Art%20of%20Spending%20Money+by+Morgan%20Housel"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "How to spend money wisely. Housel's practical advice on financial decision-making."
