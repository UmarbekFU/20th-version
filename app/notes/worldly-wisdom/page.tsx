...
export default function WorldlyWisdomPage() {
  // All data is self-contained - no external dependencies
  const title = "Worldly Wisdom"
  const author = "Charles T. Munger"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Worldly%20Wisdom+by+Charles%20T.%20Munger"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "Munger's approach to life and investing. Practical wisdom for navigating complex decisions."
  const category = "book"
