...
export default function GdelEscherBachPage() {
  // All data is self-contained - no external dependencies
  const title = "Gödel, Escher, Bach"
  const author = "Douglas Hofstadter"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=G%C3%B6del%2C%20Escher%2C%20Bach+by+Douglas%20Hofstadter"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Explores recursion, consciousness, computation—similar spirit to Deutsch. A mind-bending exploration of formal systems."
  const category = "book"
