...
export default function CollectedFictionsBayAreaEditionPage() {
  // All data is self-contained - no external dependencies
  const title = "Collected Fictions (Bay Area Edition)"
  const author = "Jorge Luis Borges"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Collected%20Fictions%20(Bay%20Area%20Edition)+by+Jorge%20Luis%20Borges"
  const spineColor = "#10b981"
  const textColor = "#ffffff"
  const summary = "A book that explores important concepts and ideas."
