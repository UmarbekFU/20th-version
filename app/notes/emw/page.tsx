...
export default function EveryMansWarPage() {
  // All data is self-contained - no external dependencies
  const title = "Every Man's War"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Every%20Man's%20War+by+Unknown"
