...
export default function AgainsttheGodsPage() {
  // All data is self-contained - no external dependencies
  const title = "Against the Gods"
  const author = "Peter L. Bernstein"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Against%20the%20Gods+by+Peter%20L.%20Bernstein"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "History of risk, a prelude to Taleb. The remarkable story of risk and how it has shaped human civilization."
  const category = "book"
