...
export default function BernsteinagainstgodsPage() {
  const note = getNoteBySlug('bernstein-against-gods')
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 prose prose-lg max-w-none">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                This is where my detailed notes and thoughts about "Against the Gods" would go. 
