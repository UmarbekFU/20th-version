...
export default function DiscoursesEnchiridionPage() {
  ...
  const title = "Discourses & Enchiridion"
  const author = "Epictetus"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Discourses%20%26%20Enchiridion+by+Epictetus"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "The complete works of the former slave turned Stoic philosopher. Epictetus's practical philosophy of freedom through acceptance."
  const category = "book"
