...
export default function AtlasShruggedPage() {
  ...
  const title = "Atlas Shrugged"
  const author = "Ayn Rand"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Atlas%20Shrugged+by+Ayn%20Rand"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The fountainhead of objectivism. Rand's magnum opus on individualism, capitalism, and the power of human reason."
