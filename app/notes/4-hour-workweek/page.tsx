...
export default function The4HourWorkweekPage() {
  // All data is self-contained - no external dependencies
  const title = "The 4-Hour Workweek"
  const author = "Timothy Ferriss"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%204-Hour%20Workweek+by+Timothy%20Ferriss"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "Escape 9-5, live anywhere, and join the new rich. Ferriss's guide to lifestyle design and productivity."
  const category = "book"
