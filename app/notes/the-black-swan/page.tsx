...
export default function TheBlackSwanPage() {
  // All data is self-contained - no external dependencies
  const title = "The Black Swan"
  const author = "Nassim Nicholas Taleb"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Black%20Swan+by+Nassim%20Nicholas%20Taleb"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The impact of highly improbable events. Taleb's magnum opus on uncertainty and rare events."
