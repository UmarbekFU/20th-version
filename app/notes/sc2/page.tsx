...
export default function TheStrangerPage() {
  // All data is self-contained - no external dependencies
  const title = "The Stranger"
  const author = "Albert Camus"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Stranger+by+Albert%20Camus"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "Camus's existential masterpiece about Meursault, a man who commits murder and faces the absurdity of existence. A profound exploration of meaning, morality, and the human condition."
