...
export default function TheRationalOptimistPage() {
  // All data is self-contained - no external dependencies
  const title = "The Rational Optimist"
  const author = "Matt Ridley"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Rational%20Optimist+by+Matt%20Ridley"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "How prosperity evolves. Ridley's argument that human progress comes from the exchange of ideas and specialization."
  const category = "book"
