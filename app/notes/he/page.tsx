          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 dark:text-gray-500 mb-6">
                Rating: {rating}/10 • Duration: 1.5 hours • <a href="https://tbpn.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Visit Source</a>
              </p>
            </div>
          </div>
