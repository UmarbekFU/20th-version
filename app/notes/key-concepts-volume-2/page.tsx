...
export default function KeyConceptsVolume2Page() {
  // All data is self-contained - no external dependencies
  const title = "Key Concepts Volume 2"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Key%20Concepts%20Volume%202+by+Unknown"
