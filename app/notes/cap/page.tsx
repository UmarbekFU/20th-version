...
export default function CrimeandPunishmentPage() {
  ...
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Crime%20and%20Punishment+by+Fyodor%20Dostoevsky"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Dostoevsky's psychological masterpiece about Raskolnikov, a young man who commits murder and grapples with guilt and redemption. A profound exploration of morality, suffering, and the human psyche."
