...
export default function TheGreatGatsbyPage() {
  ...
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Great%20Gatsby+by+F.%20Scott%20Fitzgerald"
  const spineColor = "#f59e0b"
  const textColor = "#ffffff"
  const summary = "Fitzgerald's masterpiece of the Jazz Age, exploring themes of wealth, love, and the American Dream. A tragic tale of Jay Gatsby's pursuit of the unattainable Daisy Buchanan."
