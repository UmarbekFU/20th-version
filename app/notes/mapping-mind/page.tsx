...
export default function MappingtheMindPage() {
  // All data is self-contained - no external dependencies
  const title = "Mapping the Mind"
  const author = "Rita Carter"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Mapping%20the%20Mind+by+Rita%20Carter"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "A visual guide to the brain and consciousness. Carter's accessible exploration of how the brain creates the mind."
  const category = "book"
