...
export default function AntifragilePage() {
  ...
  const title = "Antifragile"
  const author = "Nassim Nicholas Taleb"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Antifragile+by+Nassim%20Nicholas%20Taleb"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "Things that gain from disorder. Taleb's framework for systems that benefit from volatility."
  const category = "book"
