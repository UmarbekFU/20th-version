...
export default function JustPracticePage() {
  // All data is self-contained - no external dependencies
  const title = "Just Practice"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Just%20Practice+by+Unknown"
