...
export default function ExplainingSocialBehaviorPage() {
  // All data is self-contained - no external dependencies
  const title = "Explaining Social Behavior"
  const author = "Jon Elster"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Explaining%20Social%20Behavior+by+Jon%20Elster"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "More nuts and bolts for the social sciences. Elster's analysis of social mechanisms and explanations."
  const category = "book"
