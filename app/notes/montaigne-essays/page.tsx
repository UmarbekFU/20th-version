...
export default function EssaysPage() {
  ...
  const title = "Essays"
  const author = "Montaigne"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Essays+by+Montaigne"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Practical skepticism, embraced by Taleb. Montaigne's exploration of human nature and the limits of knowledge."
  const category = "book"
