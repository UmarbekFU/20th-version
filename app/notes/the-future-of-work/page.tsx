...
export default function TheFutureofWorkPage() {
  // All data is self-contained - no external dependencies
  const title = "The Future of Work"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Future%20of%20Work+by+Unknown"
