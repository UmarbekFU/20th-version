...
export default function NavalgetrichPage() {
  const note = getNoteBySlug('naval-get-rich')
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 dark:text-gray-500 mb-6">
                Listened: {note.date} • Rating: {note.rating}/10 • Duration: 1 hour
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 prose prose-lg max-w-none">
            ...
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
                This is where my detailed notes and thoughts about "How to Get Rich (Without Getting Lucky)" would go. 
