...
export default function DemonsPage() {
  ...
  const title = "Demons"
  const author = "Fyodor Dostoyevsky"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Demons+by+Fyodor%20Dostoyevsky"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "A political novel about revolutionary terrorism. Dostoyevsky's exploration of ideology and human nature."
  const category = "book"
