...
export default function MathematicsPage() {
  ...
  const author = "A.D. Aleksandrov"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Mathematics+by+A.D.%20Aleksandrov"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Its content, methods, and meaning. Aleksandrov's comprehensive introduction to mathematics."
  const category = "book"
