...
export default function SuperforecastingPage() {
  ...
  const title = "Superforecasting"
  const author = "Philip Tetlock"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Superforecasting+by+Philip%20Tetlock"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The art and science of prediction. Tetlock's study of what makes some people remarkably good at forecasting the future."
  const category = "book"
