...
export default function WarandPeacePage() {
  ...
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=War%20and%20Peace+by+Leo%20Tolstoy"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "Tolstoy's epic masterpiece chronicling the lives of Russian aristocrats during the Napoleonic Wars. A profound meditation on history, fate, free will, and the meaning of life."
