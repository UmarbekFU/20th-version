...
export default function TheCountofMonteCristoPage() {
  // All data is self-contained - no external dependencies
  const title = "The Count of Monte Cristo"
  const author = "Alexandre Dumas"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Count%20of%20Monte%20Cristo+by+Alexandre%20Dumas"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "The ultimate tale of revenge and redemption. Dumas's masterpiece of adventure and human psychology."
