...
export default function TheLordoftheRingsPage() {
  // All data is self-contained - no external dependencies
  const title = "The Lord of the Rings"
  const author = "J. R. R. Tolkien"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Lord%20of%20the%20Rings+by+J.%20R.%20R.%20Tolkien"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Tolkien's epic fantasy trilogy following Frodo Baggins's quest to destroy the One Ring. A masterpiece of world-building, mythology, and the eternal struggle between good and evil."
