...
export default function DonQuixotePage() {
  ...
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Don%20Quixote+by+Miguel%20de%20Cervantes"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Cervantes's timeless tale of the idealistic knight-errant and his faithful squire Sancho Panza. A profound exploration of reality versus illusion, madness versus wisdom, and the power of imagination."
  const category = "book"
