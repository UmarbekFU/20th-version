...
export default function MeditationsPage() {
  ...
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Meditations+by+Marcus%20Aurelius"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "The personal writings of the Roman emperor and Stoic philosopher. Aurelius's timeless wisdom on virtue, duty, and the art of living."
