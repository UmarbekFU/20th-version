...
export default function PrideandPrejudicePage() {
  ...
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Pride%20and%20Prejudice+by+Jane%20Austen"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "Austen's beloved novel about Elizabeth Bennet and Mr. Darcy, exploring themes of love, class, and social expectations in Regency England. A witty and insightful commentary on marriage and society."
  const category = "book"
