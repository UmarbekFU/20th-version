...
export default function StatisticalConsequencesofFatTailsPage() {
  ...
  const title = "Statistical Consequences of Fat Tails"
  const author = "Nassim Nicholas Taleb"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Statistical%20Consequences%20of%20Fat%20Tails+by+Nassim%20Nicholas%20Taleb"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Technical analysis of extreme events and their statistical properties. Taleb's mathematical treatment of tail risk."
  const category = "book"
