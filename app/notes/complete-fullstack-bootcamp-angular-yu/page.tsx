          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 dark:text-gray-500 mb-6">
                Rating: {rating}/10 • Duration: 65+ hours • <a href="https://www.udemy.com/course/the-complete-web-development-bootcamp/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">Visit Source</a> • Tags: web-development, javascript, react, nodejs, mongodb, html, css
              </p>
            </div>
          </div>
