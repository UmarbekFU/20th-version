...
export default function LifeReasonPage() {
  const note = getNoteBySlug('life-reason')
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 prose prose-lg max-w-none">
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">The Phases of Human Progress</h3>
                <div className="space-y-4">
                  <p>
                    Santayana's The Life of Reason is a comprehensive 
                    philosophy of human nature and society.
                  </p>
                  
                  <p>
                    The book explores how reason can guide 
