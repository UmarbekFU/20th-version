...
export default function TheLifeofReasonPage() {
  // All data is self-contained - no external dependencies
  const title = "The Life of Reason"
  const author = "George Santayana"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Life%20of%20Reason+by+George%20Santayana"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "The phases of human progress. Santayana's comprehensive philosophy of human nature and society."
  const category = "book"
