...
export default function OpenSourceEverythingPage() {
  // All data is self-contained - no external dependencies
  const title = "Open Source Everything"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Open%20Source%20Everything+by+Unknown"
