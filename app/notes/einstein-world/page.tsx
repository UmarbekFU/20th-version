...
export default function TheWorldasISeeItPage() {
  // All data is self-contained - no external dependencies
  const title = "The World as I See It"
  const author = "Albert Einstein"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20World%20as%20I%20See%20It+by+Albert%20Einstein"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Humility before uncertainty, physics and philosophy together. Einstein's philosophical reflections on science and life."
  const category = "book"
