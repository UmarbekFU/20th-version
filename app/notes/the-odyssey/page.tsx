...
export default function TheOdysseyPage() {
  // All data is self-contained - no external dependencies
  const title = "The Odyssey"
  const author = "Homer"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Odyssey+by+Homer"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Homer's epic poem following Odysseus's ten-year journey home from the Trojan War. A timeless tale of adventure, heroism, and the longing for home that has influenced literature for millennia."
