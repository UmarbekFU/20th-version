...
export default function BlackMassPage() {
  ...
  const title = "Black Mass"
  const author = "John Gray"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Black%20Mass+by+John%20Gray"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "Apocalyptic religion and the death of utopia. Gray's analysis of how secular ideologies inherit religious patterns."
  const category = "book"
