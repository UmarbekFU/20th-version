...
export default function MansSearchforMeaningPage() {
  // All data is self-contained - no external dependencies
  const title = "Man's Search for Meaning"
  const author = "Viktor Frankl"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Man's%20Search%20for%20Meaning+by+Viktor%20Frankl"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "A psychiatrist's experiences in Nazi death camps. Frankl's profound insights on finding meaning in suffering."
