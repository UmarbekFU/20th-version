...
export default function ThinkingFastandSlowPage() {
  ...
  const title = "Thinking, Fast and Slow"
  const author = "Daniel Kahneman"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Thinking%2C%20Fast%20and%20Slow+by+Daniel%20Kahneman"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The definitive work on human decision-making. Kahneman's Nobel Prize-winning insights on cognitive biases."
