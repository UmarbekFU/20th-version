...
export default function CoolToolsPage() {
  ...
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Cool%20Tools+by+Kevin%20Kelly"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "A catalog of possibilities. Kelly's comprehensive guide to tools and technologies that can enhance human capabilities and creativity."
  const category = "book"
