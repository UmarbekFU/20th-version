...
export default function OnSuccessPage() {
  ...
  const title = "On Success"
  const author = "Charles T. Munger"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=On%20Success+by+Charles%20T.%20Munger"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Munger's thoughts on achieving success. Insights from one of the world's most successful investors."
