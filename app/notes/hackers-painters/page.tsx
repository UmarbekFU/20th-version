...
export default function HackersPaintersPage() {
  // All data is self-contained - no external dependencies
  const title = "Hackers & Painters"
  const author = "Paul Graham"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Hackers%20%26%20Painters+by+Paul%20Graham"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Essays on programming, technology, and the intersection of art and code. Graham's insights on startups and creativity."
  const category = "book"
