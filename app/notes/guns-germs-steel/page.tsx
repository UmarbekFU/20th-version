...
export default function GunsGermsandSteelPage() {
  // All data is self-contained - no external dependencies
  const title = "Guns, Germs, and Steel"
  const author = "Jared Diamond"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Guns%2C%20Germs%2C%20and%20Steel+by+Jared%20Diamond"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The fates of human societies. Diamond's Pulitzer Prize-winning analysis of civilization's development."
  const category = "book"
