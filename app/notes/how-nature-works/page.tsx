...
export default function HowNatureWorksPage() {
  // All data is self-contained - no external dependencies
  const title = "How Nature Works"
  const author = "Per Bak"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=How%20Nature%20Works+by+Per%20Bak"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "The science of self-organized criticality. Bak's exploration of complexity and emergence in nature."
  const category = "book"
