...
export default function TaoTeChingPage() {
  ...
  const title = "Tao Te Ching"
  const author = "Lao Tzu"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Tao%20Te%20Ching+by+Lao%20Tzu"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "The fundamental text of Taoism. Lao Tzu's timeless wisdom on the nature of reality, virtue, and the way of effortless action."
