...
export default function SiddharthaPage() {
  ...
  const title = "Siddhartha"
  const author = "Hermann Hesse"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Siddhartha+by+Hermann%20Hesse"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "A spiritual journey of self-discovery. Hesse's classic novel about the search for meaning and enlightenment."
  const category = "book"
