...
export default function KantandthePlatypusPage() {
  // All data is self-contained - no external dependencies
  const title = "Kant and the Platypus"
  const author = "Umberto Eco"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Kant%20and%20the%20Platypus+by+Umberto%20Eco"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Essays on language and cognition. Eco's exploration of how we understand and categorize the world."
  const category = "book"
