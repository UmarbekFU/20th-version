...
export default function TheCancerCodePage() {
  // All data is self-contained - no external dependencies
  const title = "The Cancer Code"
  const author = "Jason Fung"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Cancer%20Code+by+Jason%20Fung"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "A revolutionary new understanding of a medical mystery. Fung presents a new paradigm for understanding and treating cancer."
  const category = "book"
