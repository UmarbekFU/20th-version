...
export default function PreSuasionPage() {
  ...
  const title = "Pre-Suasion"
  const author = "Robert B. Cialdini"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Pre-Suasion+by+Robert%20B.%20Cialdini"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "A revolutionary way to influence and persuade. Cialdini's latest work on the psychology of influence."
  const category = "book"
