...
export default function SeekingWisdomPage() {
  // All data is self-contained - no external dependencies
  const title = "Seeking Wisdom"
  const author = "Peter Bevelin"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Seeking%20Wisdom+by+Peter%20Bevelin"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "From Darwin to Munger. Bevelin's synthesis of wisdom from great thinkers across disciplines."
  const category = "book"
