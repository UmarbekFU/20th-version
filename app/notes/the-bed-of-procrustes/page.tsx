...
export default function TheBedofProcrustesPage() {
  // All data is self-contained - no external dependencies
  const title = "The Bed of Procrustes"
  const author = "Nassim Nicholas Taleb"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Bed%20of%20Procrustes+by+Nassim%20Nicholas%20Taleb"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Philosophical and practical aphorisms. Taleb's collection of wisdom on uncertainty and life."
