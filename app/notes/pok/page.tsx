...
export default function PowerofKnowledgePage() {
  // All data is self-contained - no external dependencies
  const title = "Power of Knowledge"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Power%20of%20Knowledge+by+Unknown"
