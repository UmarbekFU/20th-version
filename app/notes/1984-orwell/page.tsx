...
export default function Orwell1984Page() {
  // All data is self-contained - no external dependencies
  const title = "1984"
  const author = "George Orwell"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=1984+by+George%20Orwell"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Orwell's dystopian masterpiece warning about totalitarianism, surveillance, and the manipulation of truth. A chilling vision of a world where Big Brother watches everything and independent thought is a crime."
  const category = "book"
