...
export default function OrderWithoutDesignPage() {
  // All data is self-contained - no external dependencies
  const title = "Order Without Design"
  const author = "Alain Bertaud"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Order%20Without%20Design+by+Alain%20Bertaud"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "How markets shape cities. Bertaud's analysis of urban economics and city planning."
