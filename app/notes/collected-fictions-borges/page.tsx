...
export default function CollectedFictionsPage() {
  // All data is self-contained - no external dependencies
  const title = "Collected Fictions"
  const author = "Jorge Luis Borges"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Collected%20Fictions+by+Jorge%20Luis%20Borges"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The complete short stories of the Argentine master. Borges's mind-bending explorations of reality and fiction."
  const category = "book"
