...
export default function TheBeginningofInfinityPage() {
  // All data is self-contained - no external dependencies
  const title = "The Beginning of Infinity"
  const author = "David Deutsch"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Beginning%20of%20Infinity+by+David%20Deutsch"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Explanations that transform the world. Deutsch's optimistic view of progress and human potential."
  const category = "book"
