...
export default function ZerotoOnePage() {
  ...
  const author = "Peter Thiel"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Zero%20to%20One+by+Peter%20Thiel"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Notes on startups, or how to build the future. Thiel's contrarian views on innovation and monopoly."
