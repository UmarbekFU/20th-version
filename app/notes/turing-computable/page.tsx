...
export default function OnComputableNumbersPage() {
  // All data is self-contained - no external dependencies
  const title = "On Computable Numbers"
  const author = "Alan Turing"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=On%20Computable%20Numbers+by+Alan%20Turing"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "Original paper on computation, source of Deutsch's computational worldview. The foundational work of computer science."
  const category = "book"
