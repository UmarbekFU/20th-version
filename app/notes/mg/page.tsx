...
export default function MeanGenesPage() {
  // All data is self-contained - no external dependencies
  const title = "Mean Genes"
  const author = "Terry Burnham"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Mean%20Genes+by+Terry%20Burnham"
  const spineColor = "#7c3aed"
  const textColor = "#ffffff"
  const summary = "From sex to money to food, taming our primal instincts. Burnham's evolutionary perspective on human behavior."
