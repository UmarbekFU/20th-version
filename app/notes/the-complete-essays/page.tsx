...
export default function TheCompleteEssaysPage() {
  // All data is self-contained - no external dependencies
  const title = "The Complete Essays"
  const author = "Michel de Montaigne"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Complete%20Essays+by+Michel%20de%20Montaigne"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The father of the essay form. Montaigne's timeless reflections on human nature and experience."
