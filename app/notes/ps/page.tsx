...
export default function ThePoeticsofSpacePage() {
  // All data is self-contained - no external dependencies
  const title = "The Poetics of Space"
  const author = "Gaston Bachelard"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Poetics%20of%20Space+by+Gaston%20Bachelard"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "The classic look at how we experience intimate places. Bachelard's phenomenological study of space and imagination."
