...
export default function GoodCaloriesBadCaloriesPage() {
  // All data is self-contained - no external dependencies
  const title = "Good Calories, Bad Calories"
  const author = "Gary Taubes"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Good%20Calories%2C%20Bad%20Calories+by+Gary%20Taubes"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Challenging the conventional wisdom on diet and disease. Taubes's controversial take on nutrition science."
  const category = "book"
