...
export default function FoodRulesPage() {
  ...
  const title = "Food Rules"
  const author = "Michael Pollan"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Food%20Rules+by+Michael%20Pollan"
  const spineColor = "#f59e0b"
  const textColor = "#ffffff"
  const summary = "An eater's manual with 64 simple rules for healthy eating. Pollan distills nutritional wisdom into practical, memorable guidelines that cut through the confusion of modern food culture."
  const category = "book"
