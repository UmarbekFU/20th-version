...
export default function NormalAccidentsPage() {
  ...
  const title = "Normal Accidents"
  const author = "Charles Perrow"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Normal%20Accidents+by+Charles%20Perrow"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "Living with high-risk technologies. Perrow's analysis of how complex systems inevitably fail and the paradox of safety measures."
