...
export default function TheWealthofNationsPage() {
  // All data is self-contained - no external dependencies
  const title = "The Wealth of Nations"
  const author = "Adam Smith"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Wealth%20of%20Nations+by+Adam%20Smith"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The foundational text of modern economics. Smith's analysis of the division of labor and the invisible hand of the market."
  const category = "book"
