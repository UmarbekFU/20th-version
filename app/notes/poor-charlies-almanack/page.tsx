...
export default function PoorCharliesAlmanackPage() {
  ...
  const title = "Poor Charlie's Almanack"
  const author = "Peter D. Kaufman"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Poor%20Charlie's%20Almanack+by+Peter%20D.%20Kaufman"
  const spineColor = "#dc2626"
  const textColor = "#ffffff"
  const summary = "The wit and wisdom of Charles T. Munger. A comprehensive collection of Munger's speeches and writings."
  const category = "book"
