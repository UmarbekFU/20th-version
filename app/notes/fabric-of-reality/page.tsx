...
export default function TheFabricofRealityPage() {
  // All data is self-contained - no external dependencies
  const title = "The Fabric of Reality"
  const author = "David Deutsch"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Fabric%20of%20Reality+by+David%20Deutsch"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "The science of parallel universes and the nature of reality. Deutsch's unified theory of knowledge."
  const category = "book"
