...
export default function SelectedPoemsPage() {
  // All data is self-contained - no external dependencies
  const title = "Selected Poems"
  const author = "Paul Celan"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Selected%20Poems+by+Paul%20Celan"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The essential poems of one of the greatest poets of the 20th century. Celan's haunting and powerful verse."
  const category = "book"
