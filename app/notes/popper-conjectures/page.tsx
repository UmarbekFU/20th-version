...
export default function ConjecturesandRefutationsPage() {
  // All data is self-contained - no external dependencies
  const title = "Conjectures and Refutations"
  const author = "Karl Popper"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Conjectures%20and%20Refutations+by+Karl%20Popper"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Shorter, easier entry point to Popper's philosophy. Essays on the growth of scientific knowledge."
  const category = "book"
