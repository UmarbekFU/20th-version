...
export default function ThePrincePage() {
  ...
  const author = "Niccolo Machiavelli"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Prince+by+Niccolo%20Machiavelli"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "Machiavelli's controversial political treatise on power, leadership, and statecraft. A pragmatic guide to maintaining political power that remains influential and debated to this day."
  const category = "book"
