...
export default function StrawDogsPage() {
  // All data is self-contained - no external dependencies
  const title = "Straw Dogs"
  const author = "John Gray"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Straw%20Dogs+by+John%20Gray"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "Thoughts on humans and other animals. Gray's provocative critique of humanism and progress."
