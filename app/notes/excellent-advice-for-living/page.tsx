...
export default function ExcellentAdviceforLivingPage() {
  ...
  const title = "Excellent Advice for Living"
  const author = "Kevin Kelly"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Excellent%20Advice%20for%20Living+by+Kevin%20Kelly"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Wisdom I wish I'd known earlier. Kelly's collection of practical insights and life lessons learned over decades of exploration and innovation."
