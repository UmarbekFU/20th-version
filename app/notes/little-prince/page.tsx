...
export default function TheLittlePrincePage() {
  // All data is self-contained - no external dependencies
  const title = "The Little Prince"
  const author = "Antoine de Saint-Exupéry"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Little%20Prince+by+Antoine%20de%20Saint-Exup%C3%A9ry"
  const spineColor = "#f59e0b"
  const textColor = "#ffffff"
  const summary = "Saint-Exupéry's beloved fable about a young prince who travels from planet to planet, learning about life, love, and what truly matters. A profound children's book that speaks to readers of all ages."
  const category = "book"
