...
export default function DeathFuguePage() {
  ...
  const title = "Death Fugue"
  const author = "Paul Celan"
  const date = "2024"
  const rating = 10
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Death%20Fugue+by+Paul%20Celan"
  const spineColor = "#ea580c"
  const textColor = "#ffffff"
  const summary = "One of the most powerful poems about the Holocaust. Celan's masterpiece of witness and remembrance."
