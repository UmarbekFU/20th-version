...
export default function LifeofJesusPage() {
  ...
  const title = "Life of Jesus"
  const author = "Ernest Renan"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Life%20of%20Jesus+by+Ernest%20Renan"
  const spineColor = "#1e40af"
  const textColor = "#ffffff"
  const summary = "A historical and critical study of Jesus. Renan's influential biography that treats Jesus as a historical figure."
