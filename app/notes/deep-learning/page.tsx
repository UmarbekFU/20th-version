...
export default function DeepLearningPage() {
  ...
  const author = "Ian Goodfellow"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Deep%20Learning+by+Ian%20Goodfellow"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "The comprehensive textbook on deep learning. Goodfellow's authoritative guide to neural networks."
  const category = "book"
