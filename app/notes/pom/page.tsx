...
export default function ThePsychologyofMoneyPage() {
  // All data is self-contained - no external dependencies
  const title = "The Psychology of Money"
  const author = "Morgan Housel"
  const date = "2024"
  const rating = 9
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=The%20Psychology%20of%20Money+by+Morgan%20Housel"
  const spineColor = "#7c2d12"
  const textColor = "#ffffff"
  const summary = "Timeless lessons on wealth, greed, and happiness. Housel's insights on the psychology of financial decisions."
