...
export default function NeverGiveUpPage() {
  // All data is self-contained - no external dependencies
  const title = "Never Give Up"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Never%20Give%20Up+by+Unknown"
