...
export default function HappyAccidentsPage() {
  // All data is self-contained - no external dependencies
  const title = "Happy Accidents"
  const author = "Morton A. Meyers"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Happy%20Accidents+by+Morton%20A.%20Meyers"
  const spineColor = "#059669"
  const textColor = "#ffffff"
  const summary = "Serendipity in major medical breakthroughs. Meyers's exploration of how chance discoveries shaped medicine."
  const category = "book"
