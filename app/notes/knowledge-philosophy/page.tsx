...
export default function KnowledgePhilosophyPage() {
  // All data is self-contained - no external dependencies
  const title = "Knowledge Philosophy"
  const author = "Unknown"
  const date = "2024"
  const rating = 8
  const coverImage = "https://via.placeholder.com/300x400/%2310b981/ffffff?text=Knowledge%20Philosophy+by+Unknown"
