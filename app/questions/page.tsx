...
export default function QuestionsPage() {
  const questions = [
    ...
    "What is the level of resolution you'd need to replicate your brain in to create someone you'd consider to be you?",
    "What are the key questions?",
    "Why not take a pen and a piece of paper, go offline for 1 hour and resolve one of them?",
    "What's the most embarrassing message you've sent?",
    "What does good future look like?",
    ...
    "Why did the US founding fathers decide that the president must be at least 35 year old?",
    "When was the last time you were truly bored?",
    "Does time exist?",
    "Is the replication crisis in science proof that even experts are trapped in groupthink?",
    "What are you absolutely certain in?",
    ...
    "How does the history judge your work?",
    "Why will you fail?",
    "What do you know about yourself that others consistently underestimate?",
    "What views do you claim to believe in that you know are wrong but you say them because you don't want to be criticized by your employer or industry?",
    ...
    "What crazy genius that you aspire to emulate is actually just crazy?",
    ...
    "What question are you afraid to ask because you suspect I know the answer?",
    ...
    "What's one actionable from last meeting?",
    ...
    "If you could not compare myself to anyone else, how would you define a good life?",
